...
public class RequestService {
     ...
     * <p>
     *     {@link RequestDAO#findRequestsWithOffsetFromPositionByClientId(int, int, int)}
     ...
     * @return
     */
    public List<Request> findRequestsForPageByClientId(int currentPage, int recordsPerPage, int clientId){
        return dao.findRequestsWithOffsetFromPositionByClientId((currentPage-1)*recordsPerPage,
