...
<html>
  <head>
    ...
    <link rel="stylesheet" href="http://localhost:8081/finalProject_war_exploded/assets/step2.css">
        ...
        <div class="site-wrapper-inner">
          ...
          <div class="container">
              ...
              <h2 class="heading"><fmt:message key="ORDER" /></h2>
                        <!--First item-->
                        <form action="?command=form_client_room" method="post">
                            <c:if test="${wrongData eq 'true'}">
                                <fmt:message key="WRONG_INPUT"/>
                            </c:if>
                    <div class="form-group row">
                            <label for="inputName3" class="col-sm-2 col-form-label"><fmt:message key="CHOOSE_CLASS_OF_THE_ROOM" /></label>
                            <div class="col-sm-10">
                            <select class="custom-select" required name="class">
                              <option value=""><fmt:message key="CHOOSE_CLASS_OF_THE_ROOM" /></option>
                      ...
                      <!--Second item-->    
                    <div class="form-group row">
                                <label for="inputName3" class="col-sm-2 col-form-label"><fmt:message key="CHOOSE_NUM_OF_PLACES" /></label>
                                <div class="col-sm-10">
                                <select class="custom-select" name="numOfPlaces" required>
                                  <option value=""><fmt:message key="CHOOSE_NUM_OF_PLACES" /></option>
                ...
                <!--Third item-->
                <div class="form-group row">
                        <label for="inputName3" class="col-sm-2 col-form-label"><fmt:message key="DATE_FROM" /></label>
                        <div class="col-sm-10">
                                <input type="text" class="form-control is-valid"  name="dateFrom" placeholder=<fmt:message key="DATE" /> id="date-from">
                      </div>
                      </div>
                <!--Fourth item-->
                <div class="form-group row">
                        <label for="inputName3" class="col-sm-2 col-form-label" ><fmt:message key="DATE_TO" /></label>
                        <div class="col-sm-10">
                                <input type="text" class="form-control is-valid"name="dateTo" placeholder=<fmt:message key="DATE" /> id="date-to">
                      </div>
                      </div>  
                      <div class="form-group row">
                            <div class="col-sm-12">
