                ...
                <ul class="pagination justify-content-center pagination-lg">
                    <c:if test="${currentPage != 1}">
                        <li class="page-item"><a class="page-link"
                                                 href="?command=bookings&recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">Previous</a>
                        </li>
                    </c:if>
                    ...
                    <c:forEach begin="1" end="${noOfPages}" var="i">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item"><a class="page-link"
                                                         href="?command=bookings&recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    ...
                    <c:if test="${currentPage lt noOfPages}">
                        <li class="page-item"><a class="page-link"
                                                 href="?command=bookings&recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}">Next</a>
                        </li>
                    </c:if>
                </ul>
            </nav>
